...
public class ProductApi {
	...
	@Operation(httpMethod = "GET", value = "Get a product by id", description = "For administration and shop purpose. Specifying ?merchant is required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Single product found", response = ReadableProduct.class) })
	@ResponseBody
	@Parameters({ @Parameter(name = "store", dataType = "String", defaultValue = "DEFAULT"),
			@Parameter(name = "lang", dataType = "String", defaultValue = "en") })
	...
	**/
	...
	@Operation(httpMethod = "POST", value = "Calculate product price with variants", description = "Product price calculation from variants")
	@ApiResponses(value = {
