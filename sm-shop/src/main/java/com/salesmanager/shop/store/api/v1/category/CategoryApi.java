...
//					content = @Content(schema = @Schema(implementation = ReadableCategory.class))
//			)})
...
//			) })
	...
	@Operation(summary = "Get category hierarchy from root. Supports filtering FEATURED_CATEGORIES and " +
			"VISIBLE ONLY by adding ?filter=[featured] or ?filter=[visible] or ? filter=[featured,visible",
