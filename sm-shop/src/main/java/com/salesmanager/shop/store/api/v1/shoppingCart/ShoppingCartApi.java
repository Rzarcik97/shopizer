...
public class ShoppingCartApi {
	...
	@Operation(summary = "Add product to shopping cart when no cart exists, this will create a new cart id",
			description = "No customer ID in scope. Add to cart for non authenticated users, as simple as {\"product\":1232,\"quantity\":1}")
	...
	@Operation(summary = "Add to an existing shopping cart or modify an item quantity",
			description = "No customer ID in scope. Modify cart for non authenticated users, as simple as {\"product\":1232,\"quantity\":0} for instance will remove item 1234 from cart")
	@Parameters({ @Parameter(name = "store", example = "DEFAULT"),
			@Parameter(name = "lang", example = "en") })
	...
	@Operation(summary = "Remove a product from a specific cart",
			description = "If body set to true returns remaining cart in body, empty cart gives empty body. If body set to false no body ")
	@Parameters({ @Parameter(name = "store", example = "DEFAULT"),
			@Parameter(name = "lang", example = "en"),
			@Parameter(name = "body", example = "false"), })
